...
\begin{figure}[H]
    ...
    \begin{semilogyaxis}[
        ...
        xmin=0, xmax=50,
        xlabel={Chain length},
        ylabel={Largest error $\|\epsilon\|_\infty$},
        ...
        % ---------- Decryption failure ---------
        \addplot[color=maxred, domain=1:50]{2^71};
        ...
        \legend{Noise ceiling, Small Parameters, Large Parameters}
    \end{semilogyaxis}
    \end{tikzpicture}
\end{figure}