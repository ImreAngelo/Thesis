...
\pgfplotstableread[col sep=comma]{Data/ExternalProduct/bv-small.csv}\bvsmall
...
\pgfplotstableread[col sep=comma]{Data/ExternalProduct/bv-large.csv}\bvlarge
...
\begin{figure}[H]
    \centering
    \caption{RNS-BV noise growth in chained external products}
    \label{fig:bv:plot-1}
    \begin{tikzpicture}
    \begin{semilogyaxis}[
        noiseaxis,
        ...
        \addplot[only marks, mark=*, mark size=1pt, color=gaussblue]
            table[col sep=comma, x=n, y=noise] {Data/ExternalProduct/bv-small.csv};
        \addplot[only marks, mark=*, mark size=1pt, color=hpsgreen]
            table[col sep=comma, x=n, y=noise] {Data/ExternalProduct/bv-large.csv};
