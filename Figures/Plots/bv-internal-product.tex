...
\pgfplotstableread[col sep=comma]{Data/Noise/InternalProd/bv.csv}\bvlarge
...
\begin{figure}[H]
    \centering
    \caption{RNS-BV noise growth in chained internal products \textcolor{red}{TODO: Overlay graph of using accumulated result on rhs}}
    \label{fig:bv:plot-2}
    \begin{tikzpicture}
    \begin{semilogyaxis}[
        noiseaxis,
