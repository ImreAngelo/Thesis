...
\pgfplotstableread[col sep=comma]{Data/Noise/ExternalProd/hybrid-small.csv}\bvsmall
...
\pgfplotstableread[col sep=comma]{Data/Noise/ExternalProduct/hybrid.csv}\bvlarge
...
\begin{figure}[H]
    ...
    \begin{semilogyaxis}[
        ...
        \addplot[only marks, mark=*, mark size=1pt, color=gaussblue]
            table[col sep=comma, x=n, y=noise] {Data/Noise/ExternalProduct/hybrid-small.csv};
        \addplot[only marks, mark=*, mark size=1pt, color=hpsgreen]
            table[col sep=comma, x=n, y=noise] {Data/Noise/ExternalProduct/hybrid.csv};
