...
\pgfplotstableread[col sep=comma]{Data/ExternalProduct/ghs-small.csv}\bvsmall
...
\pgfplotstableread[col sep=comma]{Data/ExternalProduct/ghs-large.csv}\bvlarge
...
\begin{figure}[H]
    ...
    \begin{semilogyaxis}[
        ...
        \addplot[only marks, mark=*, mark size=1pt, color=gaussblue]
            table[col sep=comma, x=n, y=noise] {Data/ExternalProduct/ghs-small.csv};
        \addplot[only marks, mark=*, mark size=1pt, color=hpsgreen]
            table[col sep=comma, x=n, y=noise] {Data/ExternalProduct/ghs-large.csv};
