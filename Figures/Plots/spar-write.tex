...
\pgfplotstableread[col sep=comma]{Data/Noise/write-N16.csv}\bvlarge
...
\begin{figure}[H]
    ...
    \begin{semilogyaxis}[
        ...
        \addplot[only marks, mark=*, mark size=1pt, color=hpsgreen]
            table[col sep=comma, x expr=\thisrow{n}+1, y=noise] {Data/Noise/write-N16.csv};
        ...
        \legend{$\eta = 16$} % \legend{$\eta = 2$, $\eta = 16$}
    \end{semilogyaxis}
    \end{tikzpicture}
\end{figure}
