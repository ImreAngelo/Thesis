...
\begin{figure}[H]
    \centering
    \caption{Max-norm noise in $L$ after placing $\eta$ messages during a single run.}
    ...
    \begin{semilogyaxis}[
        ...
        \addplot[only marks, mark=*, mark size=1pt, color=hpsgreen]
            table[col sep=comma, x expr=\thisrow{n}+1, y=noise] {Data/Noise/write-N32.csv}; % TODO: RERUN THESE NUMBERS
