...
%%%
\begin{algorithm}[ht!]
\caption{$\mathsf{HomPlacing}^*$ for the choice of three slots~\cite{cryptoeprint:2025/860}}
\label{alg:spar:homplacing}
\begin{algorithmic}[1]
    \Require Encrypted value $V_r$
    \Require Encrypted indices $A_0, A_1, A_2$, where $A_d$ is $\log\eta$ encrypted bits $\{c_{d,0}, \dots, c_{d,\log\eta - 1}\}$
