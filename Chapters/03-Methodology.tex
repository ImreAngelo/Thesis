...
\vfill
\begin{itemize}
    \item RGSW and external products are typically not exposed in non-binary scheme implementations (even in TFHE-rs the external product is kindof hidden deep in some module)
    \item 
\end{itemize}
TFHE-style \gls{rgsw} are generally not exposed in . This thesis 
