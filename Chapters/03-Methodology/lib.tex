...
\begin{itemize}
    ...
    \item Another result: sPAR (which was built on top of this library)
    ...
    \end{enumerate}
    \item There are also two auxiliary directories \texttt{benchmarks} and \texttt{tests} that contain code to benchmark and unit test the functions, respectively.
\end{itemize}
