%% SUPERSEDED (skeleton restructure): this file is not \input anywhere. Its
%% content was absorbed into core/bv.tex + core/bv-encrypt.tex (gadget
%% structure, matrices, encryption) and Algorithms/digit-decomp.tex (signed
%% LSB decomposition). Kept temporarily for reference; delete once ch. 3
%% prose is final.
