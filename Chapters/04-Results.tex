...
%% PARAMETERS
\section{Parameters}
As a baseline I target a security parameter of $\lambda \approx 128$ according to the lattice estimator of \cite{cryptoeprint:2015/046}. The benchmarks are using the parameters from \autoref{tab:bench:params}.
...
\section{Benchmarks}
\begin{itemize}
    \item Run on AMD Ryzen 5 5600X CPU 6-core {@} 3.7 GHz with 32Gb RAM in WSL2 Ubuntu Linux 
