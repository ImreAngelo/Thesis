...
With few exceptions, all of the best performing FHE frameworks \cite{cryptoeprint:2011/277, BFV, CKKS, TFHE} rely on the hardness of (the ring-variant of) the \gls{lwe} problem first introduced in \cite{regev:2009}. 
...
%%
%% MODULUS SWITCHING
\begin{definition}[\color{red}Modulus Switching]
