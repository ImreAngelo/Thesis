...
\begin{itemize}
    \item Addition/subtraction of two polynomials in $R_Q$ is equivalent to adding/subtracting their CRT forms (modulo $q_i$)
...
\begin{itemize} % Maybe more details in appendix?
    ...
    \item The negacyclic \gls{ntt} of size $N$ requires each modulus to satisfy $q_i \equiv 1 \pmod{2N}$, which constrains the choice of RNS primes.
\end{itemize}
