...
%     We have an RNS polynomial $a \in \mathcal{B}_P$ in evaluation format, and want to express the same polynomial as $a \in \mathcal{B}_{QP}$ in an extended basis $\mathcal{B}_{QP}$.
% \end{definition}
